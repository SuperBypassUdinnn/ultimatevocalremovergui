# Ultimate Vocal Remover - Available Models

Berikut adalah daftar lengkap semua model yang tersedia dan dapat diunduh di aplikasi Ultimate Vocal Remover saat ini:
...
- MDX-Net Model: Kim InstVoc HQ *(Dihapus oleh TRvlvr dari database resmi, gunakan MDX23C-InstVoc HQ)*
